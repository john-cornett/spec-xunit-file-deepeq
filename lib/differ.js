(function () {
	...
	objectDiff = function (obj1, obj2) {
		var change, key, keys1, keys2, ref, ref1, result, score, subscore, value1, value2;
		result = {};
		score = 0;
		...
		for (key in obj1) {
			...
			score += 20;
			value2 = obj2[key];
			ref = diffWithScore(value1, value2), subscore = ref[0], change = ref[1];
			if (change) {
				result[key] = change;
			}
	...
	arrayDiff = function (obj1, obj2, stats) {
		var allEqual, change, i, i1, i2, item, item1, item2, j, j1, j2, k, l, len, m, n, o, op, opcodes, originals1, originals2, p, ref, ref1, ref10, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, result, score, seq1, seq2;
		originals1 = {
			__next: 1
		};
	...
	diff = function (obj1, obj2) {
		...
		ref = diffWithScore(obj1, obj2), score = ref[0], change = ref[1];
		return change;
	};
	...
	diffJSON = function (obj1, obj2, options) {
		return diff(JSON.parse(obj1), JSON.parse(obj2));
	};
